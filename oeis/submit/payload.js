window.OEIS_SUBMIT = {
 ...
 "drafts": [
   ...
   "edits": [
    {
     ...
     "code": "%C",
     "action": "add",
     "text": "There is no further term below 2.4*10^15: an exhaustive scan from 0 to 2403150456127592 finds none. - ~~~~"
    },
    {
     "field": "Link",
     "code": "%H",
  ...
  },
  {
   ...
   "what": "bound comment",
   "summary": "Add a search-bound comment: no further term below 2.4*10^15.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Comment",
  ...
  },
  {
   ...
   "what": "DATA +8 terms, bound comment, a-file 36 rows, Xref +A096265",
   "summary": "Extend DATA by 8 terms; add a search-bound comment; add an a-file with the bounding primes; add cross-references to A096265.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Data",
    ...
    },
    {
     ...
     "code": "%H",
     "action": "add",
     "text": "Mike Koss, <a href=\"/A087770/a087770.txt\">Table of the first 36 records with both bounding primes and both gaps</a>"
    },
    {
     "field": "Xref",
     "code": "%Y",
