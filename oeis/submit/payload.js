window.OEIS_SUBMIT = {
 ...
 "drafts": [
  ...
  },
  {
   ...
   "what": "DATA +1 terms, bound comment, a-file 56 rows, Xref +A087770, Xref +A096265",
   "summary": "Extend DATA by 1 terms; add a search-bound comment; add an a-file with the bounding primes; add cross-references to A087770, A096265.",
   "blocked_on": [
   ...
   "edits": [
    ...
    },
    {
     ...
     "code": "%C",
     "action": "add",
     "text": "There is no further term below 3.6*10^15: an exhaustive scan from 0 to 3689973560872464 finds none. - ~~~~"
    },
    {
     "field": "Link",
     "code": "%H",
     "action": "add",
     "text": "Mike Koss, <a href=\"/A023186/a023186.txt\">Table of the first 56 records with both bounding primes and both gaps</a>"
    },
    {
     "field": "Xref",
     "code": "%Y",
  ...
  },
  {
   ...
   "what": "bound comment",
   "summary": "Add a search-bound comment: no further term below 3.6*10^15.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Comment",
  ...
  },
  {
   ...
   "what": "DATA +2 terms, bound comment, a-file 32 rows",
   "summary": "Extend DATA by 2 terms; add a search-bound comment; add an a-file with the bounding primes.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Data",
    ...
    },
    {
     ...
     "code": "%H",
     "action": "add",
     "text": "Mike Koss, <a href=\"/A058867/a058867.txt\">Table of the first 32 records with both bounding primes and both gaps</a>"
    }
   ],
   "upload": {
    "kind": "a-file",
  ...
  },
  {
   ...
   "what": "DATA +9 terms, bound comment, a-file 37 rows, Xref +A096265",
   "summary": "Extend DATA by 9 terms; add a search-bound comment; add an a-file with the bounding primes; add cross-references to A096265.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Data",
    ...
    },
    {
     ...
     "code": "%H",
     "action": "add",
     "text": "Mike Koss, <a href=\"/A087770/a087770.txt\">Table of the first 37 records with both bounding primes and both gaps</a>"
    },
    {
     "field": "Xref",
     "code": "%Y",
