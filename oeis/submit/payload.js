window.OEIS_SUBMIT = {
 ...
 "drafts": [
  ...
  },
  {
   ...
   "what": "DATA +3 terms, bound comment, a-file 58 rows, Xref +A087770, Xref +A096265",
   "summary": "Extend DATA by 3 terms; add a search-bound comment; add an a-file with the bounding primes; add cross-references to A087770, A096265.",
   "blocked_on": [
   ...
   "edits": [
    ...
    },
    {
     ...
     "code": "%C",
     "action": "add",
     "text": "There is no further term below 5.6*10^15: an exhaustive scan from 0 to 5613838913435200 finds none. - ~~~~"
    },
    {
     "field": "Link",
     "code": "%H",
     "action": "add",
     "text": "Mike Koss, <a href=\"/A023186/a023186.txt\">Table of the first 58 records with both bounding primes and both gaps</a>"
    },
    {
     "field": "Xref",
     "code": "%Y",
  ...
  },
  {
   ...
   "what": "bound comment",
   "summary": "Add a search-bound comment: no further term below 5.6*10^15.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Comment",
  ...
  },
  {
   ...
   "what": "DATA +4 terms, bound comment, a-file 34 rows",
   "summary": "Extend DATA by 4 terms; add a search-bound comment; add an a-file with the bounding primes.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Data",
  ...
  },
  {
   ...
   "what": "DATA +10 terms, bound comment, a-file 38 rows, Xref +A096265",
   "summary": "Extend DATA by 10 terms; add a search-bound comment; add an a-file with the bounding primes; add cross-references to A096265.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Data",
    ...
    },
    {
     ...
     "code": "%H",
     "action": "add",
     "text": "Mike Koss, <a href=\"/A087770/a087770.txt\">Table of the first 38 records with both bounding primes and both gaps</a>"
    },
    {
     "field": "Xref",
     "code": "%Y",
