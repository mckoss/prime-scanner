window.OEIS_SUBMIT = {
 ...
 "drafts": [
  ...
  },
  {
   ...
   "edits": [
    ...
    },
    {
     ...
     "code": "%C",
     "action": "add",
     "text": "There is no further term below 2.7*10^15: an exhaustive scan from 0 to 2775385481641202 finds none. - ~~~~"
    },
    {
     "field": "Link",
     "code": "%H",
  ...
  },
  {
   ...
   "what": "bound comment",
   "summary": "Add a search-bound comment: no further term below 2.7*10^15.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Comment",
  ...
  },
  {
   ...
   "what": "DATA +1 terms, bound comment, a-file 31 rows",
   "summary": "Extend DATA by 1 terms; add a search-bound comment; add an a-file with the bounding primes.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Data",
    ...
    },
    {
     ...
     "code": "%H",
     "action": "add",
     "text": "Mike Koss, <a href=\"/A058867/a058867.txt\">Table of the first 31 records with both bounding primes and both gaps</a>"
    }
   ],
   "upload": {
    "kind": "a-file",
