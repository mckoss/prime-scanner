window.OEIS_SUBMIT = {
 ...
 "drafts": [
  ...
  },
  {
   ...
   "edits": [
    ...
    },
    {
     ...
     "code": "%C",
     "action": "add",
     "text": "There is no further term below 5.7*10^15: an exhaustive scan from 0 to 5716751743587790 finds none. - ~~~~"
    },
    {
     "field": "Link",
     "code": "%H",
  ...
  },
  {
   ...
   "what": "bound comment",
   "summary": "Add a search-bound comment: no further term below 5.7*10^15.",
   "blocked_on": null,
   "edits": [
    {
     "field": "Comment",
